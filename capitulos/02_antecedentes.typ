...
Una de las primeras y más influyentes soluciones fue el desarrollo de modelos de relevancia. El articulo que introdujo estos modelos @relevance-models con implementaciones como RM3 o PRM @PRM, indica que en lugar de depender exclusivamente de los términos de la consulta original, se puede aplicar una técnica que utiliza dos etapas para refinar la búsqueda. En este primer articulo se presenta la arquitectura general de un modelo de relevancia.
