...
#pad(left:15pt)[
*b) Comparar los resultados de los métodos QPP con estudios previos*: Se logró mediante el análisis cuantitativo del _Capítulo VI_, donde se utilizaron métricas de correlación estandarizadas (Kendall, Pearson) para contrastar los resultados obtenidos. En particular, los valores alcanzados, por ejemplo, del dataset _Antique_, se alinearon con los benchmarks reportados recientemente en @zendel2024qpptk, validando la consistencia de la evaluación.
]
