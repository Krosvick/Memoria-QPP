...
Para la evaluación de _QPP_ se utiliza un protocolo experimental que utiliza las métricas de efectividad calculadas por consulta (por ejemplo, _AP_, _MAP_, _nDCG_) correlacionándolas directamente con el valor del predictor para la misma consulta. La comparación emplea *coeficientes de correlación de rangos* y se acompaña de *pruebas de significancia e intervalos de confianza* para estimar la robustez. De este modo, la utilidad del predictor se juzga por la magnitud y la estabilidad de las correlaciones y por su capacidad para guiar decisiones.
