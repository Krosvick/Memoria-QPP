...
=== Significancia de las correlaciones observadas
\
...
En tercer lugar, aun con los resutlados prometedores obtenidos en ciertos casos como NQC y UEF-NQC, cabe recalcar que las correlaciones siguen siendo aun bajas para la mayoría de los métodos, lo cual sugiere que la tarea de predecir el rendimiento de las consultas sigue siendo una tarea compleja y que el desarollo de métodos más sofisticados que puedan capturar mejor los matices que afectan el rendimiento de la recuperación de información sigue siendo una tarea pendiente.
