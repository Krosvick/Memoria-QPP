...
=== QPPTK en TIREx
\
Un reciente estudio relevante para el presente trabajo de título es el desarrollado por Zendel, Fröbe y Faggioli @zendel2024qpptk en 2024, que proporciona una referencia fundamental al implementar y evaluar un marco de predicción del rendimiento de consultas (QPP) utilizando el _Query Performance Prediction Toolkit_ (QPPTK) dentro de la plataforma TIREx. En este trabajo @zendel2024qpptk, los autores analizaron el desempeño de 12 métodos de predicción en combinación con diversos modelos de recuperación de información y 23 conjuntos de datos, incluyendo benchmarks reconocidos como TREC Robust04 y MS MARCO, por lo que, la amplitud de la evaluación y su enfoque en la reproducibilidad de los experimentos lo convierten en un recurso valioso para este trabajo de título.
