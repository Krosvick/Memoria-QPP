...
\
A continuación, se revisan estudios relevantes relacionados con la predicción del rendimiento de consultas, presentando los principales métodos utilizados en la literatura, para posteriormente, analizar el uso de _datasets_ y entornos de experimentación para la comparación de métodos, destacando investigaciones previas que han servido como base para el diseño experimental de este proyecto.
